...
// this code working properlly you can use it 
...
const Speedmetre = () => {
  ...
  return (
    <div className="bg-gray-800 p-7 rounded-lg shadow-lg text-white w-full ">
    {/* Dropdown for selecting days */}
    <div className="mb-4">
      <label className="block mb-2 text-sm font-medium">Select Days:</label>
      <select 
    ...
    <div className="flex justify-center">
      <div className="w-full h-[20vh]">
        <ReactSpeedometer
          ...
          currentValueText={`PROJECT (past ${selectedDays} days)`}
          textColor="white"
          width={undefined} // Ensures dynamic scaling
          height={undefined} // Ensures dynamic scaling
        />
      </div>
    </div>
  </div>
