...
const Locationselect = ({ onProjectsUpdate }) => {
    ...
    return (
        <div className="p-2 bg-gray-800 rounded-2xl shadow-lg max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-white text-center">Select Location</h2>

            {/* Table Structure */}
            <div className="overflow-auto w-full bg-gray-800 shadow-md rounded-md">
                <ul className="border border-gray-700 rounded-md overflow-hidden">
                    {/* Table Header */}
                    <li className="flex bg-gray-700 font-semibold text-sm text-gray-200 border-b border-gray-600">
